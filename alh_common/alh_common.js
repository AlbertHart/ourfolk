...
function get_self(sarg, sarg2, sarg3, sarg4, sarg5) {
    ...
    if (caller_line2) {
        ...
        self = sprintf("*** %s(%s%s%s%s%s) *** Called by: %s: %s\n", self_name, sarg, sarg2, sarg3, sarg4, sarg5, sname, sline);
    }
    else {
        self = sprintf("*** %s(%s%s%s%s) *** No caller\n", self_name, sarg, sarg2, sarg3, sarg4, sarg5);
    }
